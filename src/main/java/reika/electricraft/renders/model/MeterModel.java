...
public class MeterModel extends Model<net.minecraft.util.Unit>
{
    
    public static final Identifier TEXTURE_LOCATION = Identifier.fromNamespaceAndPath(MODID, "textures/metertex.png");
