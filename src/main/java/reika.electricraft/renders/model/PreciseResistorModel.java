...
public class PreciseResistorModel extends ResistorBaseModel {
    ...
    public PreciseResistorModel(ModelPart modelPart) {
        super(modelPart);
        this.root = modelPart;

        this.band4a = modelPart.getChild("band4a");
        this.band4b = modelPart.getChild("band4b");
